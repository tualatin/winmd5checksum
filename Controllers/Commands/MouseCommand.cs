...
namespace Org.Vs.WinMd5Checksum.Controllers.Commands
{
  /// <summary>
  /// Mouse behaviours
  /// </summary>
  public class MouseCommand
  {
    ...
    /// MouseUp command
    /// </summary>
    public static readonly DependencyProperty MouseUpCommandProperty = DependencyProperty.RegisterAttached("MouseUpCommand", typeof(ICommand), typeof(MouseCommand),
    ...
    /// MouseDown command
    /// </summary>
    public static readonly DependencyProperty MouseDownCommandProperty = DependencyProperty.RegisterAttached("MouseDownCommand", typeof(ICommand), typeof(MouseCommand),
    ...
    /// MouseLeave command
    /// </summary>
    public static readonly DependencyProperty MouseLeaveCommandProperty = DependencyProperty.RegisterAttached("MouseLeaveCommand", typeof(ICommand), typeof(MouseCommand),
    ...
    public static readonly DependencyProperty MouseLeftButtonDownCommandProperty = DependencyProperty.RegisterAttached("MouseLeftButtonDownCommand", typeof(ICommand),
      typeof(MouseCommand), new FrameworkPropertyMetadata(MouseLeftButtonDownCommandChanged));
    ...
    public static readonly DependencyProperty MouseLeftButtonUpCommandProperty = DependencyProperty.RegisterAttached("MouseLeftButtonUpCommand", typeof(ICommand),
      typeof(MouseCommand), new FrameworkPropertyMetadata(MouseLeftButtonUpCommandChanged));
    ...
    /// MouseMove command
    /// </summary>
    public static readonly DependencyProperty MouseMoveCommandProperty = DependencyProperty.RegisterAttached("MouseMoveCommand", typeof(ICommand), typeof(MouseCommand),
    ...
    public static readonly DependencyProperty MouseRightButtonDownCommandProperty = DependencyProperty.RegisterAttached("MouseRightButtonDownCommand", typeof(ICommand),
      typeof(MouseCommand), new FrameworkPropertyMetadata(MouseRightButtonDownCommandChanged));
    ...
    public static readonly DependencyProperty MouseRightButtonUpCommandProperty = DependencyProperty.RegisterAttached("MouseRightButtonUpCommand", typeof(ICommand),
      typeof(MouseCommand), new FrameworkPropertyMetadata(MouseRightButtonUpCommandChanged));
    ...
    /// MouseWheel command
    /// </summary>
    public static readonly DependencyProperty MouseWheelCommandProperty = DependencyProperty.RegisterAttached("MouseWheelCommand", typeof(ICommand), typeof(MouseCommand),
